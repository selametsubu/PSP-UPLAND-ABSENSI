<x-app-full-layout>
    ...
    <x-app-card>
        ...
        <form id="app-form" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 fv-row">
                    <x-app-label>Password</x-app-label>
                    <x-app-input-text name="password" id="password"></x-app-input-text>
                </div>
                <div class="col-lg-3 fv-row">
                    <x-app-label>Konfirmasi Password</x-app-label>
                    <x-app-input-text name="password_confirmation" id="password_confirmation"></x-app-input-text>
                </div>
                <div class="col-lg-6 offset-6">
                    <div class="text-muted">Kosongkan bagian ini jika tidak ingin mengubah Password</div>
                </div>
            </div>
        ...
        <x-slot name="footer">
            <div class="row">
                <div class="col-lg-6">
                    <x-app-btn-delete id="btn-destroy"></x-app-btn-delete>
                </div>
                <div class="col-lg-6">
